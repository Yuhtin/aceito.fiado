import type { CreditFeatures, CreditRequest, CreditScoreUser } from './types';
import type { NormalizedOpenFinanceData, NormalizedTransaction } from './pluggy/types';
import { average, clamp, round, standardDeviation } from './utils/math';
import { isWithinDays, monthKey } from './utils/dates';
import { DEBT_TERMS, FOOD_ACTIVITY_TERMS, NON_PRODUCTIVE_TERMS, PRODUCTIVE_TERMS } from './score-rules';
