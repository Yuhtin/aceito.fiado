...
import type {
  ...
  RiskLevel,
  ScoreEngineResult
} from './creditScore.types.js';
import { buildAttentionFactors, buildPositiveFactors, buildUserExplanation } from './explanationBuilder.js';
import { ENGINE_VERSION, SCORE_WEIGHTS } from './scoreRules.js';
